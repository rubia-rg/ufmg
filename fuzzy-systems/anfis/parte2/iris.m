...
load './data/iris-species/data.csv';
load './data/iris-species/labels.csv';
...
for i=0:(length(C))
   ...
   plot(data(classidx, 1), data(classidx, 4), 'Marker', 'o', 'LineStyle','none')
   hold on
end
...
for i=0:(length(C))
   ...
   plot(x_test(classidx, 1), x_test(classidx, 4), 'Marker', 'o', 'LineStyle','none')
   hold on
end
